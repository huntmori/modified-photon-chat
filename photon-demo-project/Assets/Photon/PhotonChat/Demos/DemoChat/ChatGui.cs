...
namespace Photon.Chat.Demo
{
    ...
    public class ChatGui : MonoBehaviour, IChatClientListener
    {
        ...
        public void Connect()
        {
            ...
            Dictionary<string, object> postBody = new Dictionary<string, object>();
            postBody.Add("RealId", new System.Random().Next());
            postBody.Add("UserGuid", Guid.NewGuid().ToString());
            this.chatClient.AuthValues.SetAuthPostData(postBody);
        ...
        public void OnSubscribed(string[] channels, bool[] results)
        {
            ...
            {
                this.chatClient.PublishMessage(channel, "says 'hi'.", true); // you don't HAVE to send a msg on join but you could.
        ...
        public void OnPrivateMessage(string sender, object message, string channelName)
        {
            ...
            Debug.Log("sender:" + sender + "\tmessage:" + message.ToString() + "\tchannelName:" + channelName);
